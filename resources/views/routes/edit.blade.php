              ...
              <div class="col-lg-4">
                <div class="form-group focused">
                  ...
                  <input type="number" id="initial_kilometer" class="form-control" name="initial_kilometer"
                    placeholder="Km" value="{{ $route->initial_kilometer }}">
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-group focused">
                  <label class="form-control-label" for="final_kilometer">Kilômetro final<span
                      class="small text-danger">*</span></label>
                  <input type="number" id="final_kilometer" class="form-control" name="final_kilometer" placeholder="Km"
                    value="{{ $route->final_kilometer }}">
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-group focused">
